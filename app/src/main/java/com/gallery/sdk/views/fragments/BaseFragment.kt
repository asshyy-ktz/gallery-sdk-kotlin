package com.gallery.sdk.views.fragments
...
import com.gallery.sdk.utils.Media
...
//        requireContext().resources.getString(R.string.app_name)
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            "${Environment.DIRECTORY_DCIM}/GallerySDK/"
        } else {
            "${requireContext().getExternalFilesDir(Environment.DIRECTORY_DCIM)}/GallerySDK/"
        }
    }
